...
const BUILTIN_PRESETS = [
  { name: 'Polaroid Mini',             photo_w_cm: 5.4,  photo_h_cm: 8.6,  wb_top_mm: 2.5, wb_bottom_mm: 2.5, wb_left_mm: 2.5, wb_right_mm: 2.5 },
  { name: 'Polaroid 2R',               photo_w_cm: 6.0,  photo_h_cm: 9.0,  wb_top_mm: 2.5, wb_bottom_mm: 2.5, wb_left_mm: 2.5, wb_right_mm: 2.5 },
  { name: 'Polaroid 7x10',             photo_w_cm: 7.0,  photo_h_cm: 10.0, wb_top_mm: 3.0, wb_bottom_mm: 3.0, wb_left_mm: 3.0, wb_right_mm: 3.0 },
  { name: 'Polaroid SQUARE',           photo_w_cm: 7.0,  photo_h_cm: 9.0,  wb_top_mm: 3.0, wb_bottom_mm: 3.0, wb_left_mm: 3.0, wb_right_mm: 3.0 },
  { name: 'Polaroid 3 STRIP Landscape', photo_w_cm: 7.7, photo_h_cm: 17.8, wb_top_mm: 3.0, wb_bottom_mm: 3.0, wb_left_mm: 3.0, wb_right_mm: 3.0 },
  { name: 'Polaroid 3R',               photo_w_cm: 8.6,  photo_h_cm: 12.6, wb_top_mm: 3.5, wb_bottom_mm: 3.5, wb_left_mm: 3.5, wb_right_mm: 3.5 },
  { name: 'Polaroid WIDE',             photo_w_cm: 11.0, photo_h_cm: 9.0,  wb_top_mm: 3.5, wb_bottom_mm: 3.5, wb_left_mm: 3.5, wb_right_mm: 3.5 },
  { name: 'Polaroid 4R',               photo_w_cm: 10.0, photo_h_cm: 15.0, wb_top_mm: 4.0, wb_bottom_mm: 4.0, wb_left_mm: 4.0, wb_right_mm: 4.0 },
  { name: 'Polaroid SNAPSHOT A',       photo_w_cm: 10.0, photo_h_cm: 15.0, wb_top_mm: 4.0, wb_bottom_mm: 4.0, wb_left_mm: 4.0, wb_right_mm: 4.0 },
  { name: 'Polaroid SNAPSHOT B',       photo_w_cm: 11.5, photo_h_cm: 17.0, wb_top_mm: 4.5, wb_bottom_mm: 4.5, wb_left_mm: 4.5, wb_right_mm: 4.5 },
  { name: 'Polaroid 3 STRIP',          photo_w_cm: 5.0,  photo_h_cm: 15.0, wb_top_mm: 2.5, wb_bottom_mm: 2.5, wb_left_mm: 2.5, wb_right_mm: 2.5 },
  { name: 'Polaroid 4 STRIP',          photo_w_cm: 5.0,  photo_h_cm: 18.5, wb_top_mm: 2.5, wb_bottom_mm: 2.5, wb_left_mm: 2.5, wb_right_mm: 2.5 },
